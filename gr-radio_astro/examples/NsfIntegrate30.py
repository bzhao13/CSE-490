...
# Generated: Tue Jun  9 22:44:01 2020
##################################################
...
class NsfIntegrate30(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._Gain3_line_edit.returnPressed.connect(
        	lambda: self.set_Gain3(eng_notation.str_to_num(str(self._Gain3_line_edit.text().toAscii()))))
        ...
        self._Gain2_line_edit.returnPressed.connect(
        	lambda: self.set_Gain2(eng_notation.str_to_num(str(self._Gain2_line_edit.text().toAscii()))))
        ...
        self.top_grid_layout.addWidget(self._qtgui_vector_sink_f_0_0_win, 3,2,6,6)
        ...
        self.top_grid_layout.addWidget(self._qtgui_histogram_sink_x_0_win, 3,0,4,2)
...
def main(top_block_cls=NsfIntegrate30, options=None):
